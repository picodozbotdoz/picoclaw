...
const (
        ...
        PromptSlotRetrievedContext PromptSlot = "retrieved_context"
...
const (
        ...
        PromptSourceRetrievedContext   PromptSourceID = "context.injected"
...
func builtinPromptSources() []PromptSourceDescriptor {
        return []PromptSourceDescriptor{
                ...
                {
                        ID:              PromptSourceRetrievedContext,
...
func slotPriority(slot PromptSlot) int {
        ...
        case PromptSlotMemory:
                return 700
        case PromptSlotRetrievedContext:
                return 698
