...
type turnExecution struct {
        ...
        // Dynamic thinking level tracking (Phase 3, WS 3.1)
        dynamicThinkingLevel ThinkingLevel   // effective thinking level for current iteration
        thinkingModeStats    []ThinkingModeStat // per-iteration thinking mode statistics
        postToolCall         bool            // true when this iteration follows tool execution
        isRetry              bool            // true when this iteration is a retry after compression
