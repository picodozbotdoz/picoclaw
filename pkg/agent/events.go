...
const (
        ...
        EventKindError
        // EventKindExploreStart is emitted when the exploration phase begins.
        EventKindExploreStart
        // EventKindExploreEnd is emitted when the exploration phase completes.
        EventKindExploreEnd
        // EventKindVerifyStart is emitted when the verification phase begins.
        EventKindVerifyStart
        // EventKindVerifyEnd is emitted when the verification phase passes.
        EventKindVerifyEnd
        // EventKindVerifyFail is emitted when the verification phase detects a failure.
        EventKindVerifyFail
...
// ExploreStartPayload describes the start of an exploration phase.
type ExploreStartPayload struct{}

// ExploreEndPayload describes the completion of an exploration phase.
type ExploreEndPayload struct {
        FilesRead   int `json:"files_read"`
        SearchesRun int `json:"searches_run"`
        ImportHops  int `json:"import_hops"`
        TokensUsed  int `json:"tokens_used"`
}

// VerifyStartPayload describes the start of a verification phase.
type VerifyStartPayload struct {
        ProjectType string `json:"project_type"`
        BuildCmd    string `json:"build_cmd"`
        TestCmd     string `json:"test_cmd"`
}

// VerifyEndPayload describes a successful verification phase.
type VerifyEndPayload struct {
        BuildPassed bool `json:"build_passed"`
        TestPassed  bool `json:"test_passed"`
}

// VerifyFailPayload describes a verification failure.
type VerifyFailPayload struct {
