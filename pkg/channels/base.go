...
// GetBus returns the message bus associated with this channel, or nil if
// the channel was created without one. This is needed by channel-specific
// handlers (e.g. chat member events) that publish non-message events directly.
