...
func DefaultConfig() *Config {
        ...
        return &Config{
                ...
                ModelList: []*ModelConfig{
                        ...
                        // DeepSeek V4 - https://platform.deepseek.com/
                        // V4 models support 1M context window, automatic prefix caching,
                        // reasoning modes (non-think, think-high, think-max), and 384K max output.
                        {
