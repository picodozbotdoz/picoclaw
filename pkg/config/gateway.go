...
// TracingConfig holds the configuration for the advanced monitoring/observability system.
type TracingConfig struct {
        ...
        LLMCallRetentionDays   int     `json:"llm_call_retention_days,omitempty"`
        ContextRetentionDays   int     `json:"context_retention_days,omitempty"`
        SessionRetentionDays   int     `json:"session_retention_days,omitempty"`
        PruneIntervalMinutes   int     `json:"prune_interval_minutes,omitempty"`
        SnippetMaxChars        int     `json:"snippet_max_chars,omitempty"`
        CaptureRequestMsgs     bool    `json:"capture_request_messages,omitempty"`
        CaptureResponseContent bool    `json:"capture_response_content,omitempty"`
        SanitizeSecrets        bool    `json:"sanitize_secrets,omitempty"`
}
